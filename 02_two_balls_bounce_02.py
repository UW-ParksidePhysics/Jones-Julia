...
initial_position1 = vp.vector(-10., 10., 0.)
initial_velocity1 = vp.vector(25., -25., 0.)
ball1 = vp.sphere(pos=initial_position1, radius=0.5, color=vp.color.purple, make_trail=True)

initial_position2 = vp.vector(-10., -10., 0.)
initial_velocity2 = vp.vector(25., 25., 0.)
ball2 = vp.sphere(pos=initial_position2, radius=0.5, color=vp.color.cyan, make_trail=True)
...
while time < stop_time:
    ...
    if ball1.pos.x > wall.pos.x + 0.30:
        ball_velocity1.x = -ball_velocity1.x  # reverse ball velocity aka bounce
    ball1.pos.x += ball_velocity1.x * time_step
    ball1.pos.y += ball_velocity1.y * time_step
    ball1.pos.z += ball_velocity1.z * time_step
    if ball2.pos.x > wall.pos.x + 0.30:
